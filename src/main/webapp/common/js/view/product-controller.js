...
//수강신청(온라인) > 단과 > 수강리스트
function getLectureApplyTeacherTypeList(menuCtgKey, stepCtgKey, goodsType) {
    if (menuCtgKey == null || menuCtgKey == undefined) return;
    var data = {
        stepCtgKey : stepCtgKey,
        goodsType : goodsType
                   ...
                   if (cmpList.teacherTypeInfo != null) {
                       ...
                       for (var j = 0; j < teacherInfoLIST.length; j++) {
                           ...
                           retrunHtml += "<ul class=\"teacherList\">";
                               retrunHtml += "<li><span class=\"thumb\"><img src='"+ teacherInfoLIST[j].imageListUrl +"'></span></li>";
                                           ...
                                           retrunHtml += "<div class=\"lectureRow\">";
                                               retrunHtml += "<ul class=\"lectureList\">";
                                                   retrunHtml += "<li class=\"w15p\">";
                                                       retrunHtml += "<span class=\"btn_learnType green\">"+ teachLec.ctgName +"</span>";
                                                   retrunHtml += "</li>";
