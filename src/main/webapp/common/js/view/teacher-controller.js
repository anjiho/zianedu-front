            ...
            for (var i = 0; i < selList.length; i++) {
                ...
                if (cmpList.teacherLectureList.length > 0) {
                    ...
                    for (var j = 0; j < lecList.length; j++) { //강의목록리스트
                        ...
                        retrunHtml += '<span class="learnView">샘플보기 <a href="javascript:void(0);" onclick="OpenSamplePlayer(' + "'"  + lecList[j].lowVideo + "'" + ');" class="btn_s btn_quality" >일반화질</a> <a href="#" class="btn_s btn_quality on">고화질</a></span>';
