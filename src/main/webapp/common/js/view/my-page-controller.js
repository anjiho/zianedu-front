...
function getVideoSignUpDetailInfo(gkey, device, jlecKey, tagId) {
    ...
    if (infoList != null) {
        ...
        dwr.util.addRows(tagId, selList, [
            ...
            function(data) {return '<a href="javascript:void(0);" onclick="OpenLecPlayer(' + "'"  + data.vodFileLow + "'" + ');" class="black small">일반화질</a>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="OpenLecPlayer(' + "'"  + data.vodFileHigh + "'" + ');" class="blue small">고화질</a>';}
        ], {escapeHtml:false});
    }
    return detailInfo;
}
