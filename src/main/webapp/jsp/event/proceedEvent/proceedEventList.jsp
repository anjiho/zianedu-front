...
<script>
    ...
    function fn_search(val) {
        ...
        if(val == "new") sPage = "1";
        eventList('PROCEED', sPage, 10, searchType, searchText);
    }
    
    function detailEvent(idx) {
        innerValue('idx', idx);
        goPage('event','detailProceed');
    }
</script>
    ...
    <div id="wrap">
        ...
        <div id="container">
            <div class="inner">
                ...
                <div class="tabBox">
                    <ul>
                        <li class="active"><a href="javascript:goPageNoSubmit('event','proceedList');">진행 이벤트</a></li>
