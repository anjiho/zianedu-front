...
<script>
    ...
    $(document).ready(function () {
        ...
        if(infoList != null){
            ...
            innerValue('searchStartDate', infoList.result.eventStartDate);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.resultCode == 200) {
                            ...
                            var idx = getInputTextValue('idx');
                            var result = updateEventInfo(idx, title, content, searchStartDate, searchEndDate, targetName, fileName, detailUrl);
                ...
                <div class="boardWrap eventBoard">
                    <div class="boardWrap">
                        ...
                        <div class="btnArea">
                            ...
                            <a href="javascript:modifyEvent();" class="btn_m radius w110">수정</a>
                        </div>
                    </div>
                </div>
                <!--//서브 컨텐츠-->
