                ...
                <div class="free">
                    <div class="tab_topContent tabContent">
                        <ul class="tabBox tBox2">
                            <li class="active"><a href="#">이론</a></li>
                            <li><a href="#">기출풀이</a></li>
                        </ul>
                        <!-- 이론 -->
                        <div class="tabPage">
                            ...
                            <div class="direct_view">
                                <a href="" class="btn_inline w140">목록으로</a>
                                <div class="item">
                                    <div class="inner">
                                        <div class="thumb">
                                            <img class="myarea_poster" src="../images/content/fm01.png" />
                                        </div>
                                        <div class="desc">
                                            <div>
                                            ...
                                            <p class="tit">2020 시험대비 안효선 한달로 끝나는 국어 기초특강 1부</p>
                                            <span>안효선 교수님</span>
                                            <div class="utill">
                            ...
                            <div class="tbd_02">
                                ...
                                <div class="scroll">
                                    ...
                                    <table class="disnonepc scrolltbw">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <p><b>01강</b> 180509_어문규정표준 발음법</p>
                                                <span>56시간</span>
                                                <a href="" class="black small">일반화질</a>
                                                <a href="" class="blue small">고화질</a>
                                            </td>
