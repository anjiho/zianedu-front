...
<div id="player-container" style="width:1024px;">
    <div class="sts_title" id="id_title" style="height:568px;background:black url('') no-repeat center center; color: white;">01강 200108_단원예상문제풀이-1_현대 시_1920년대 p.1 (첨부자료 참조)</div>
