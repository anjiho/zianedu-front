...
$( document ).ready(function() {
    ...
    getTeacherPageList("teacherPage1", 1080, 0);//공통과목 교수진 페이지 리스트
    getTeacherBannerList("teacherList1", 1080, 0);//공통과목 교수진 리스트
    getMajorTeacherPageList("teacherPage2", 1080, 1);//전공과목 교수진 페이지 리스트
    getMajorTeacherBannerList("teacherList2", 1080, 1);//전공과목 교수진 리스트
