...
$( document ).ready(function() {
   ...
   // getTeacherBannerList("teacherList1", 1086, 0);//공통과목 교수진
    //getMajorTeacherBannerList("teacherList2", 1086, 1);//전공과목 교수진
    getTeacherPageList("teacherPage1", 1086, 0);//공통과목 교수진 페이지 리스트
    getTeacherBannerList("teacherList1", 1086, 0);//공통과목 교수진 리스트
    getMajorTeacherPageList("teacherPage2", 1086, 1);//전공과목 교수진 페이지 리스트
    getMajorTeacherBannerList("teacherList2", 1086, 1);//전공과목 교수진 리스트
