        ...
        <div class="inner">
            <div id="mainVisual">
                ...
                <div class="mainBannerReview disnonepc">
                    <div class="inner">
                        <a href="#"><img src="http://52.79.40.214/Upload/100/contents/0424_s_zianpass_mobile.jpg" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="mainBannerReview disnone">
                <div class="inner">
                    <a href="#"><img src="http://52.79.40.214/Upload/100/contents/0424_s_zianpass_pc.jpg" alt=""></a>
                </div>
            </div>
            <!-- 지안에듀 합격자 영상 -->
            ...
            <div class="mainBanner">
                <div class="inner">
                    <a href="javascript:goPageNoSubmit('bigExam','examApply');"><img src="http://52.79.40.214/Upload/100/contents/0102_on_02.jpg"></a>
                </div>
            </div>
...
$( document ).ready(function() {
    ...
    getTeacherPageList("teacherPage1", 829, 0, teacherMenuCtgKey);//공통과목 교수진 페이지 리스트
    //getTeacherBannerList("teacherList1", 829, 0, teacherMenuCtgKey);//공통과목 교수진 리스트
    getMajorTeacherPageList("teacherPage2", 829, 1, teacherMenuCtgKey);//전공과목 교수진 페이지 리스트
    //getMajorTeacherBannerList("teacherList2", 829, 1, teacherMenuCtgKey);//전공과목 교수진 리스트
