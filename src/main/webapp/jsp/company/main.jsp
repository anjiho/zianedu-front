...
<style>
    ...
    #map_ma {width:494px; height:250px; clear:both; border:solid 1px red;}
    #map_ma1 {width:494px; height:250px; clear:both; border:solid 1px red;}
</style>
<script>
    function map(){
        ...
        //var map = new google.maps.Map(document.getElementById('map_ma1'), mapOptions);
