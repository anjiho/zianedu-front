                ...
                <div id="tab-1" class="tab-content active">
                        <div class="companyInfo">
                            ...
                            <div class="location">
                                <h2>찾아오시는 길</h2>
                                <div class="company1">
                                    <div class="mApi" id="id_map_kr">api</div>
                                    <h3>1관 찾아오시는 길</h3>
                                    <table>
                                        <colgroup>
                                            <col width="10%">
...
<script>
    ...
    function SetMap()
    {
        ...
        // var size_y = 90;
        //
        // var image		= new google.maps.MarkerImage("/Content/image/front/introduce/map_pointer.png", null, null, null, new google.maps.Size(size_x,size_y));
        // var krLatlng	= new google.maps.LatLng(37.513354,126.944848);
        // var krOptions	= {zoom: 16, center:krLatlng, mapTypeId: google.maps.MapTypeId.ROADMAP};
        // var krMap		= new google.maps.Map(document.getElementById("id_map_kr"), krOptions);
        // var krLatLng	= new google.maps.LatLng(37.513354,126.944848);
        // var krMarker	= new google.maps.Marker({position: krLatLng, map:krMap, icon: image});
...
// 말풍선 내용
    ...
    function SetMap2()
    {
        ...
        var image		= new google.maps.MarkerImage("/Content/image/front/introduce/map_pointer.png", null, null, null, new google.maps.Size(size_x,size_y));
        var krLatlng	= new google.maps.LatLng(37.513032,126.947499);
        var krOptions	= {zoom: 16, center:krLatlng, mapTypeId: google.maps.MapTypeId.ROADMAP};
        var krMap		= new google.maps.Map(document.getElementById("id_map_kr_2"), krOptions);
        var krLatLng	= new google.maps.LatLng(37.513032,126.947499);
        var krMarker	= new google.maps.Marker({position: krLatLng, map:krMap, icon: image});
    }
</script>
