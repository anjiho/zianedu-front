            ...
            <div class="inner">
                <div id="mainVisual">
                    ...
                    <div class="mainBannerReview disnonepc">
                        <div class="inner">
                            <a href="#"><img src="http://52.79.40.214/Upload/100/contents/0424_hg_zianpass_mobile.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="mainBannerReview disnone">
                    <div class="inner">
                        <a href="#"><img src="http://52.79.40.214/Upload/100/contents/0424_hg_zianpass_pc.jpg" alt=""></a>
                    </div>
                </div>
                <!-- 지안에듀 합격자 영상 -->
