    ...
    function saveErrata() {
        ...
        if(sessionUserInfo != null) {
            if (filesTempArr.length == 0) { //파일 없을때
                ...
                var result = saveBoard(10059, sessionUserInfo.userKey, title, content, 0, 0, '');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.resultCode == 200) {
                            ...
                            var title = getInputTextValue("title");
                            var content = $('textarea[name="writeContent"]').val();
                            var result = saveBoard(10059, sessionUserInfo.userKey, title, content, 0, 0, fileName);
            ...
            <div class="inner">
                ...
                <div class="boardWrap">
                    ...
                    <div class="btnArea">
                        ...
                        <a href="javascript:saveErrata();" class="btn_m w110 black">등록</a>
                    </div>
                </div>
