            ...
            <div class="inner">
                ...
                <div class="boardWrap eventBoard">
                    ...
                    <div class="btnArea divGroup noMargin">
                        <div class="left">
                            <a href="javascript:goPage('bigExam','modifyBigReview')" class="btn_inline w110" id="modifyBtn">수정</a>
                        </div>
                        <div class="right">
                            <a href="javascript:goPage('bigExam','bigReviewList')" class="btn_inline bdblue w110">목록</a>
                        </div>
                    </div>
                </div>
